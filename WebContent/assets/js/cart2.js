...
function requestProduct(){
	...
	$.ajax({
		...
		success : function(success){
			...
			loadToShowProduct();
			console.log("Success Data is"+ success);
		},
...
function loadToShowProduct(){
	...
	responseItems.forEach((product,i)=>{
      ...
      <td>
      <button class="btn btn-primary btn-sm" onclick="addMoreItem(${product.id})"><i class="fa fa-plus"></i></button>
      
      <span>${getItemCount(product.id)}</span>
      
      <button class="btn btn-danger btn-sm" onclick="removeMoreItem(${product.id})"><i class="fa fa-minus"></i></button>
      
      <button class="btn btn-warning btn-sm" onclick="deleteMoreItem(${product.id})"><i class="fa fa-trash"></i></button>
